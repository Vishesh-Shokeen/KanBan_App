<script>
    ...
    $:subTaskDone = subtaskValues.filter(x => x == true).length
    const closeFn = (e) => {
                    ...
                    [activeBoard]: {
                        ...
                        [updatedColumn]: {
                            ...
                            [info.taskName]: {
                                ...
                                subTaskDone,
                                totalSubtask: info.totalSubtask,
        ...
        <div class="subTaskWrapper">
            {#each subtaskKeys as subTask}
                <label class="subTaskLabel">
                    <input
                        bind:checked={info.subtask[subTask]}
                        name={subTask}
                        type="checkbox"
                    />
                    <span>{subTask}</span>
